...
public class NetPackageExplosionParams : NetPackage
{
	...
	public override void ProcessPackage(World _world, GameManager _callbacks)
	{
		...
		GameObject result = _callbacks.ExplosionClient(worldPos, rotation, explosionData.ParticleIndex, explosionData.BlastPower, (float)explosionData.EntityRadius, (float)explosionData.BlockDamage, entityId, explosionChanges);
		if (isCustom)
		{
